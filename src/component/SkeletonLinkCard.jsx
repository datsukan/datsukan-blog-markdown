...
exports.SkeletonLinkCard = void 0;
const SkeletonLinkCard = ({ className = "" }) => {
    return (<span className={`flex h-32 animate-pulse overflow-hidden rounded-lg border border-gray-300 bg-primary ${className}`}>
...
exports.SkeletonLinkCard = SkeletonLinkCard;
